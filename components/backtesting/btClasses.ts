...
export const bt = {
  ...
  input:
    "w-full rounded-xl border border-white/[0.08] bg-[#0c0c0e] px-3 py-2.5 text-sm text-slate-100 outline-none ring-[#ff3c3c]/0 transition focus:border-[#ff3c3c]/40 focus:ring-2 focus:ring-[#ff3c3c]/20 font-mono",
  btnPrimary:
