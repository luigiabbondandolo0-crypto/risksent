      ...
      >
        <header className="mb-4 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <span
              className={`${bt.btnPrimary} pointer-events-none cursor-default py-2 text-xs opacity-90`}
            >
              <Plus className="h-3.5 w-3.5" />
              New strategy
            </span>
            <span
              className={`${bt.btnGhost} pointer-events-none cursor-default py-2 text-xs`}
            >
