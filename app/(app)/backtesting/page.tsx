    ...
    <div className="relative space-y-8">
      ...
      {!loading && !isDemoMode && strategies.length === 0 && (
        <motion.div
          ...
          className="rs-card relative flex flex-col items-center gap-5 overflow-hidden py-16 text-center"
          style={{
        ...
        >
          <div
            ...
            style={{ background: "radial-gradient(circle, #6366f1, transparent)" }}
          />
          <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#6366f1]/10">
          ...
          <button
            type="button"
            onClick={() => setShowCreateStrategy(true)}
            className="relative z-10 rounded-xl bg-[#6366f1] px-6 py-2.5 font-mono text-sm font-semibold text-white transition-all hover:bg-[#4f46e5]"
          >
            Create Strategy
          </button>
        </motion.div>
