...
const TZ_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: "Asia/Bangkok", label: "Bangkok / Hanoi (ICT)" },
  ...
  return (
    <div className="relative mx-auto max-w-2xl space-y-8 pb-16">
      ...
      >
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-[10px] font-mono text-slate-400">Applied to all trade times across the app.</p>
          </div>
          <div>
      ...
      <p className="text-center text-xs font-mono text-slate-500">
        <Link href="/app/dashboard" className="text-slate-500 hover:text-slate-900">
          ← Back to dashboard
        </Link>
      </p>
